...
export default class MealTitle extends React.Component {
    constructor(props) {
        super(props)
    }
    state = {
    ...
    render() {
        ...
        return (
            <View style={styles.container}>
                ...
                <View style={{ height: '5%', flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }}>
                    <Text>How long? </Text>
                    <Picker
                ...
                <View style={{ width: '100%', height: '9%', flexDirection: 'row', justifyContent: 'flex-end', margin: 5 }}>
                    <TouchableOpacity style={[styles.next, { backgroundColor: this.state.imageupload && this.state.uploadtitle ? '#715c84' : '#b1b1b1', }]} touchActive={true} onPress={() => {
                        this.props.navigation.navigate('MealSteps',
                            {
                                ...
                                mainImage: this.state.selectImage.localUri
                            })
                    }
                    } >
                        <View>
